...
public class BillManagement extends javax.swing.JFrame {
   ...
   private TotalPrice t;
    ...
    private void paymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentActionPerformed
        // TODO add your handling code here:
    	//l=new LoginPage();
    	userEmail=LoginPage.uemail;// getting the email id of the current user
         
    	Properties props= new Properties();
		// using gmail smtp server to send the mail
		...
		Session session =Session.getDefaultInstance(props,
				new javax.mail.Authenticator()
				{
					...
					{
						return new PasswordAuthentication("mansisahu1480@gmail.com", "Everythingispossible@123");
					}
				}
				
				);
		try {
			// we are calling session in this message
			Message message= new MimeMessage(session);
			message.setFrom(new InternetAddress("mansisahu1480@gmail.com"));
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(userEmail));
			message.setSubject("Food Court Details");
			message.setText("Today your booking details are");
			...
			JOptionPane.showMessageDialog(null, "Unable to sent message");
		}
		o.delete();
		text.setText("");
